...
/**
 * 	\defgroup   Marques     Module Marques
 *  \brief      enable multi-brand management with Dolibarr.
 *  \file       htdocs/Multi-marques/core/modules/modMulti-marques.class.php
 *  \ingroup    Marques
 *  \brief      Description and activation file for module Marques
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Marques
 */
class modMarques extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "[pre-alpha]Permet une gestion multi-marques dans dolibarr.";
		...
		$this->dirs = array('/marques','/marques/default');
		...
		// );
		// $this->const = array(
		// 	0 => array('MARQUE_KEY', 'chaine', substr(md5(time()),0,8),'Change it to force client to resync',1,'current',0),
        ...
        // Dictionaries
	    if (! isset($conf->marques->enabled))
        {
        	$conf->marques=new stdClass();
        	$conf->marques->enabled=0;
        }
        ...
        */
		...
		$this->menu[$r++] = array(	'fk_menu'=>'fk_mainmenu=companies,fk_leftmenu=contacts',			                // Put 0 if this is a top menu
									...
									'mainmenu'=>'companies',
									'leftmenu'=>'contacts',
									'url'=>'/marques/marques.php;leftmenu=contacts',
									'langs'=>'marques@marques',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>190,
									'enabled'=>'$conf->marques->enabled',	// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r++] = array(	'fk_menu'=>'fk_mainmenu=agenda',			                // Put 0 if this is a top menu
									...
									'titre'=>'Marques',
									'mainmenu'=>'agenda',
									'url'=>'/marques/marques.php;mainmenu=agenda',
									'langs'=>'marques@marques',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>190,
									'enabled'=>'$conf->marques->enabled',	// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
	...
	function init($options='')
	{
		...
		$result=$this->_load_tables('/marques/sql/');
